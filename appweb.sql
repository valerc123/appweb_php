...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 16-05-2019 a las 01:51:51
...
INSERT INTO `categoriaproductos` (`id`, `nombre`, `fecharegistro`, `fechamodificacion`) VALUES
...
(3, '111', 'vQajxpfb99feLguJm3OO3nR0PzyhNze58c+yPJkSd5VpYm8xbTN0aDgxbmVhZGhjMGs1NmMzbjZwbnYwcGpsYg==', '', 2000, 11600, 5, 0),
(7, '111', 'Fsv2bzKmWjtrnJD9Zcr0mPVv2Eh4hr5p/zS0Yzzyay5zODM3b2kzMWpra2tvdG83NmFxOTFoZTBjNWJlc25pYQ==', '', 2000, 11600, 5, 0),
(8, '111', 'oi/pAv5FxEKnungiXKlJc2xXeZ0t5Hd3i+4NB2DOnvJvdWxtNTF0Y2J1MzBldXY1bG1sMnQ4MjlwNnB0YzNtcQ==', '', 2000, 2320, 1, 0);
...
--
ALTER TABLE `pedidos_detalle`
  MODIFY `pkid` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
